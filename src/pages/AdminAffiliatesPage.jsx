                          ...
                          <tr key={aff.id} onClick={() => navigate(`/admin/affiliates/${aff.id}`)} className="hover:bg-white/[0.05] transition cursor-pointer">
                            <td className="px-6 py-4">
                              ...
                              <div className="text-xs text-white/40 mt-1">
                                {aff.coupons?.length || 0} Total Coupons
                              </div>
                            </td>
                            ...
                            <td className="px-6 py-4">
                              <div className="flex flex-wrap gap-2">
                                {aff.coupons?.map(c => (
                                  <div key={c.id} className={`text-xs font-mono px-2 py-0.5 rounded ${c.is_active ? 'bg-white/10 text-white' : 'bg-red-900/30 text-red-400'}`}>
                                    {c.coupon_code}
                                  </div>
                                ))}
                              </div>
